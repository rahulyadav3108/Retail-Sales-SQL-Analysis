...
I initially came across a YouTube tutorial focused on practicing SQL with a retail sales dataset. Using the tutorial as a starting point, I created a GitHub repository and downloaded the retail_sales dataset provided for the practice.

The initial exercise contained 10 SQL questions designed to help practice fundamental data analysis concepts. I worked through all 10 questions and wrote my own SQL queries to solve them.
